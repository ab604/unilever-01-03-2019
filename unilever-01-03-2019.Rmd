...
```{r facs-data,echo=FALSE,fig.retina=6,fig.asp=0.8,out.width="90%",cache=F,warning=FALSE}
# Plot facs data
...
```{r, iedb-logos, fig.retina=4, echo=FALSE,fig.asp=0.8,out.width="100%",message=F, cache=TRUE}
# IEDB logos
...
```{r, wt_logos,fig.retina=4,fig.asp=0.8,out.width="100%", echo=FALSE, cache=TRUE}
ggseqlogo(wt_logos)
```
...
```{r, wt_preds,fig.retina=6,echo=FALSE,fig.asp=0.6,out.width="100%", cache=TRUE}
...
```{r dncb-mods-table, out.width="100%",echo=FALSE, cache=TRUE}
...
```{r kera-scan,warning=FALSE, echo=FALSE,fig.retina=4,fig.asp=0.7,out.width="100%", cache=TRUE}
...
```{r glut-scan,warning=FALSE, echo=FALSE,fig.retina=4,fig.asp=0.7,out.width="100%", cache=TRUE}
...
```{r keratin-mhc, echo=FALSE,cache=TRUE}
...
```{r gst-mhc,echo=FALSE, cache=TRUE}
...
```{r, upset-a2,fig.retina=4, fig.asp=0.8,out.width="100%", echo=FALSE, cache=TRUE}
...
```{r, upset-2-a2,fig.retina=4,fig.asp=0.8,out.width="100%", echo=FALSE, cache=TRUE}
du2_a2 <- a2_dat %>% 
  filter(length == 9) %>% 
  select(peptide, exp_type) %>% 
  group_by(exp_type,peptide) %>% 
...
```{r, iedb-a2-logos, fig.retina=4, echo=FALSE,fig.asp=0.8,out.width="100%",message=F, cache=TRUE}
# IEDB logos
...
```{r, a2_logos,fig.retina=4,fig.asp=0.8,out.width="100%", echo=FALSE, cache=TRUE}
ggseqlogo(a2_logos)
```
...
```{r, a2_preds,fig.retina=6,echo=FALSE,fig.asp=0.6,out.width="100%", cache=TRUE}
...
```{r a2-dncb-mods-table, out.width="100%",echo=FALSE, cache=TRUE}
# Find DNCB modifications
...
```{r a2-rini-scan, warning=FALSE, echo=FALSE,fig.retina=4,fig.asp=0.7,out.width="100%", cache=TRUE}
...
```{r a2-ker-scan, warning=FALSE, echo=FALSE,fig.retina=4,fig.asp=0.7,out.width="100%", cache=TRUE}
# Labels 
dat_text <- data.frame(
...
```{r kerr-II-mhc, echo=FALSE,cache=TRUE}
...
```{r example-turnover,fig.retina=4,fig.asp=0.6,out.width="100%", echo=FALSE, cache=TRUE}
proto_example %>% 
